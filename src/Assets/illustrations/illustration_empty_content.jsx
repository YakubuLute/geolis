    ...
    <Box {...other}>
      ...
      >
        ...
        <path
          ...
          opacity={0.2}
        />
        <path fill="#FFAB00" d="M182.67 256h-17.34l-30-75h77.34z" />
        <path
          fill="#FFD666"
          d="M182.67 256h-17.34l-30-75h77.34z"
          opacity={0.24}
        />
        <path fill="#FFAB00" d="M332.67 256h-17.34l-30-75h77.34z" />
        <path
          fill="#FFD666"
          d="M332.67 256h-17.34l-30-75h77.34z"
          opacity={0.24}
        />
        <path fill="#FFAB00" d="M182.67 106h-17.34l-30-75h77.34z" />
        <path
          fill="#FFD666"
          d="M182.67 106h-17.34l-30-75h77.34z"
          opacity={0.24}
        />
        <path fill="#FFAB00" d="M332.67 106h-17.34l-30-75h77.34z" />
        <path
          fill="#FFD666"
          d="M332.67 106h-17.34l-30-75h77.34z"
          opacity={0.24}
        />
        <path fill="#FFAB00" d="M257.67 181h-17.34l-30-75h77.34z" />
        <path
          fill="#FFD666"
